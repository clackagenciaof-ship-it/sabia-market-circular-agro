...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sabiá Market connects local food producers and buyers, promoting sustainability and reducing waste." },
      { property: "og:description", content: "Sabiá Market connects local food producers and buyers, promoting sustainability and reducing waste." },
      { name: "twitter:description", content: "Sabiá Market connects local food producers and buyers, promoting sustainability and reducing waste." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/e9d065a7-fe71-43f9-b9b3-f94f5583f936/id-preview-a0aa73a4--5bfb22b2-72fb-4059-8011-264eacad73e4.lovable.app-1779902095398.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/e9d065a7-fe71-43f9-b9b3-f94f5583f936/id-preview-a0aa73a4--5bfb22b2-72fb-4059-8011-264eacad73e4.lovable.app-1779902095398.png" },
    ],
